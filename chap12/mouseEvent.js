...
function init() {
    //div要素内をマウスが移動した時の処理。
    document.getElementById("outerBox").addEventListener("mousemove", function(event) {
        // 内側のp要素にマウスのdiv要素内座標を表示。
        document.getElementById("innerBox").textContent = "x=" + event.offsetX + ":y=" + event.offsetY;
